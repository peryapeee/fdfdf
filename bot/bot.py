...
def admmainmenu(message):
    ...
    if message.text == 'Выйти из админ панели😎':
        ...
        msg = bot.send_message(
            cid, 'Выберите категорию товара, которого нужно удалить:', reply_markup=keyboard)
        ...
        msg = bot.send_message(
            cid, 'Выберите категорию товара, которого нужно редактировать: ', reply_markup=keyboard)
...
def admaddcategories(message):
    ...
    if message.text != 'Назад':
        ...
        keyboard.add(*[types.KeyboardButton(text=admbutton)
                       for admbutton in ['Добавить товар🤲', 'Удалить товар🙌', 'Редактировать товар👐', 'Выйти из админ панели😎']])
...
def delpositionadm(message):
    ...
    if message.text != 'Назад':
        ...
        keyboard = types.ReplyKeyboardMarkup(1, row_width=2, selective=0)
        keyboard.add(*[types.KeyboardButton(text=admbutton)
                       for admbutton in ['Добавить товар🤲', 'Удалить товар🙌', 'Редактировать товар👐']])
